    ...
    <div className='wrapper-sheet1'>
        <div className='content'>
          ...
          <div className='grid-tenant-signs'>
            <div>
              <div className='sign'>  
                  <img src={signTenant1} onLoad={()=>printDocument()}/>
                  <p> {nameTenant1} </p>
                  <p> {data.date}</p>
              </div>
            </div>
            <div>
              <div className='sign'>  
                  <img src={signTenant2} onLoad={()=>printDocument()} />
                  <p> {nameTenant2} </p>
                    <p> {data.date}</p>
              </div>
            </div>
         ...
         <div className='sign'>  
            <img src={signLandlord} onLoad={()=>printDocument()} />
            <p> {nameLandlord} </p>
            <p> {data.date}</p>
         </div>
